...
public class TwitterActivity extends ListActivity {
    ...
    final static String ScreenName = "Revolar";
    final static String LOG_TAG = TwitterActivity.class.getSimpleName();
    ...
    private class DownloadTwitterTask extends AsyncTask<String, Void, String> {
        final static String CONSUMER_KEY = "aA23JBYz0xrKrWoYNLKd0oiKI";
        final static String CONSUMER_SECRET = "cujxceo92OIoGQDRCVLXDJ9GXkG2c8XLxbwRZAvCxZBdCxed9u";
